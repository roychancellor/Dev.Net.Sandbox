...
namespace NJINSimulator.Common.ActiveMQ
{
    public sealed class AMQServices
    {
        private static readonly AMQServices _instance = new AMQServices();
        ...
        public static AMQServices Instance
        {
            get
            {
                return _instance;
        ...
        {
            var connecturi = new Uri("activemq:tcp://localhost:61616"); // TODO: Put in config file
